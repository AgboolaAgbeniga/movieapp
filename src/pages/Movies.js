...
import { discoverMovies, getImageUrl } from '../api/Api';
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="pt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-white mb-2">
              {filters.genres.length > 0
                ? `${getGenreNameFromId(filters.genres[0])} Movies`
                : 'Movies'
              }
            </h1>
            <p className="text-gray-400">
              {filters.genres.length > 0
                ? `Explore the best ${getGenreNameFromId(filters.genres[0]).toLowerCase()} movies`
          ...
          <div className="bg-gray-800 rounded-lg p-4 mb-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={() => handleFiltersChange({ ...filters, sortBy: 'release_date.desc' })}
                  className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${
          ...
          <div className="mb-6">
            <p className="text-gray-400">
              {loading ? 'Loading movies...' : `${movies.length} movies found`}
            </p>
          </div>
                ...
                <div key={movie.id} className="group relative">
                  <Link to={`/movies/${movie.id}`} className="block">
                    <div className="aspect-[2/3] overflow-hidden rounded-lg bg-gray-700 relative">
                      <img
                        src={getImageUrl(movie.poster_path, 'w500') || '/placeholder.png'}
                        alt={movie.title}
            ...
            <div className="text-center py-12">
              <div className="mb-6">
                <svg className="mx-auto h-24 w-24 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m0 0V3a1 1 0 011-1h2a1 1 0 011 1v1M7 4H5a1 1 0 00-1 1v16a1 1 0 001 1h14a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 01-1-1z" />
                </svg>
              </div>
