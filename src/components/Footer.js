        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Moviepedia</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your ultimate destination for movies and TV shows. Discover, explore, and enjoy the best entertainment content.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/movies?sort=top_rated" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Top Rated
                </Link>
              </li>
              <li>
                <Link to="/movies?sort=upcoming" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Upcoming
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-400 text-sm">
                © {currentYear} Moviepedia by Agbeniga Agboola Emmanuel. All rights reserved.
              </p>
            </div>
          </div>
        </div>
